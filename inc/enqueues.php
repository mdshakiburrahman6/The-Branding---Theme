...
function the_branding_enqueues(){
    ...
    // Single Product CSS
    wp_register_style('the_branding_single_prodcut', get_template_directory_uri() . '/assets/css/single-product.css',  array(), '1.0.0', 'all');
    wp_enqueue_style('the_branding_single_prodcut');
    ...
    // Single Product JS
    wp_register_script('the_branding_single_prodcut', get_template_directory_uri() . '/assets/js/single-product.js');
    wp_enqueue_script('the_branding_single_prodcut');
    ...
    =====================*/ 
    // Font
    wp_register_style('the_branding_font', 'https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&display=swap');
    wp_enqueue_style('the_branding_font');
